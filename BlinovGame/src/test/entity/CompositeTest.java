...
public class CompositeTest {
    ...
    public static Object[][] dataProviderMethod()
    {
        ...
        return new Object[][]{{humanSquad,orcArmy,expectedOrcArmy},{orcArmy,humanSquad,expectedHumanSquad}};
    }
    @Test (dataProvider = "data-provider")
    public void battleTest(Composite attacker, Composite defender, Composite expectedDefenderResult){
